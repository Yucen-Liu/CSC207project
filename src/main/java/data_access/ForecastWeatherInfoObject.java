...
public class ForecastWeatherInfoObject implements ForecastWeatherInfo {

    private final CommonCityFactory cityFactory;

    public ForecastWeatherInfoObject(CommonCityFactory cityFactory) {
        this.cityFactory = cityFactory;
    }

    public City getForecastWeather(String loc, int count){
        ...
        //Change this below to get appropriate information
